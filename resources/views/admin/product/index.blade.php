...
@include('inc.admin.nav')
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">description produits</th>
                                            <th scope="col">prix produits</th>
                                            <th scope="col">Quantite produits</th>
                                            <th scope="col">image produits</th>
                                            <th scope="col"
                                            >Modifier</th>
                                    ...
                                    <tbody>
                                        @foreach ($product as $index => $p  )
                                            <tr>
                                               ...
                                               <td>{{ $p->qte }}</td>
                                               <td>
                                                <img src = "{{asset($p->photo)}}" class="rounded mx-auto d-block" width="95"/>
                                               </td>
                                               <td>
                                                    <a data-bs-toggle="modal"
                                                    data-bs-target="#editproduct{{$p->id}}" class="btn btn-info">Modifier </a>
                                                </td>
                                                <td>
                                                    <a onclick="return confirm('vous-voulez vraiment supprimer cette produit')"
                    ...
                    <div class="row g-0 justify-content-between align-items-center h-100 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-900">Thank you for creating with phoenix<span
                                    ...
                                    class="d-sm-none">2022 &copy; <a href="https://themewagon.com"></a></p>
                        </div>
                        <div class="col-12 col-sm-auto text-center">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ajout  produit</h5><button class="btn p-1"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="categorie" id="" class="form-control">
                                ...
                                <option value="{{$c->id}}">{{$c->name}} 1</option>
                               @endforeach
                            </select>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            @error('photo')
                            placeholder="selection image produit....">
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                            @enderror
    ...
    @foreach ($product as $index => $p  )
     ...
     <!-- modal modifier -->
     <div class="modal fade" id="editproduct{{$p->id}}
