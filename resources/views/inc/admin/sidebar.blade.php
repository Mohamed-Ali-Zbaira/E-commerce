            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <li class="nav-item"><a class="nav-link active" href="/admin/categories">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="cast"></span></span><span class="nav-link-text"><a
                                    href="/admin/categories"> categories</a></span></div>
                    </a></li>
                ...
                <li class="nav-item"><a class="nav-link active" href="/admin/product">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/admin/commandes">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="cast"></span></span><span
                                class="nav-link-text">Les Commandes</span></div>
                    </a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="cast"></span></span><span
                                class="nav-link-text">E-Tunisia</span></div>
                    </a></li>
