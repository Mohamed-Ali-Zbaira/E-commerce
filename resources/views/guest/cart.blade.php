                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        @foreach ($commande as $cmd)
                            @foreach ($cmd->lignecommandes as $lc)
                                <tr>
                                    <td class="align-middle"><img src="{{URL::asset($lc->product->photo)}}" alt=""
                                        style="width: 75px;"> </td>
                                    <td class="align-middle"> {{ $lc->product->name }}</td>
                                    ...
                                    <td class="align-middle">{{ $lc->qte * $lc->product->price }} TND</td>
                                    <td class="align-middle">
                                        <a href="{{url('/delete-ligne-commande?id='.$lc->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></a href="/client/lc/{idlc}/destroy"></td>
                                </tr>
                            @endforeach
                        @endforeach
                    </tbody>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">{{number_format($totale, 3)}} TND</h6>
                        </div>
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold">{{number_format($totale + 10, 3)}} TND</h5>
                        </div>
