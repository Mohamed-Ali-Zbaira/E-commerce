    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{URL::asset($product->photo)}}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <p class="mb-4">{{$product->description}}</p><br>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-4">review {{count($product->reviews)}} {{$product->name}}</h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="/client/review/store" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" max="5" min="1" class="form-control" name="rate" placeholder="your rating...!" />
                                    </div>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100"src = "{{URL::asset($prod->photo)}}" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">{{$prod->name}}</h6>
                            <div class="d-flex justify-content-center">
                                <h6></h6>{{$prod->price}}<h6 class="text-muted ml-2"></h6>
                            </div>
                        </div>
